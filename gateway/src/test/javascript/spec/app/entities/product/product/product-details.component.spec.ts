...
import ProductDetailComponent from '@/entities/product/product/product-details.vue';
import ProductClass from '@/entities/product/product/product-details.component';

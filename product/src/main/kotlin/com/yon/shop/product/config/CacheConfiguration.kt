...
class CacheConfiguration(
    ...
    fun hazelcastInstance(jHipsterProperties: JHipsterProperties): HazelcastInstance {
        ...
        val hazelCastInstance = Hazelcast.getHazelcastInstanceByName("product")
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized")
            return hazelCastInstance
        }
        val config = Config()
        config.instanceName = "product"
    ...
    private fun initializeDomainMapConfig(jHipsterProperties: JHipsterProperties): MapConfig =
        MapConfig("com.yon.shop.product.domain.*").apply { timeToLiveSeconds = jHipsterProperties.cache.hazelcast.timeToLiveSeconds }
